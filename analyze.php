...
<nav class="navbar navbar-default navbar-fixed-top" id="navi_bar">
  ...
  <div class="collapse navbar-collapse" id="myNavbar">
    <ul class="nav navbar-nav navbar-right">
      ...
      <li><a href="ask-gov.php" >Ask Goverment</a></li>
      <li><a href="track-queries.php">Dashboard</a></li>
...
<div class="container-fluid">
  <div class="row">
    ...
    <table class="news_data" style="width:100%;border:1px solid #66a3ff;" bgcolor="#ffffff" >
       <tr style="border:1px solid #66a3ff;background:#66a3ff;"><td><font color="white" size="3">Indication </font></td></tr>
